...
<div class="col-md-12">
    ...
    <div class="row">
        <div class="form-group col-lg-12">
            <input type="text" class="form-control" name="emp_name" placeholder="Employer's Full Name" value="<?php if (isset($formData) && !empty($formData->emp_name)){echo $formData->emp_name;} ?>">
        </div>
    </div>
    <div class="row">
        <div class="form-group col-lg-4">
            <input type="text" class="form-control" name="emp_address" id="emp_address" placeholder="Employer's Address" value="<?php if (isset($formData) && !empty($formData->emp_address)){echo $formData->emp_address;} ?>">
        </div>
        <div class="form-group col-lg-2">
            <input type="text" class="form-control" name="emp_unit" id="emp_unit" placeholder="Employer's Unit Number" value="<?php if (isset($formData) && !empty($formData->emp_unit)){echo $formData->emp_unit;} ?>">
        </div>
        <div class="form-group col-lg-2">
            <input type="text" class="form-control" name="emp_city" id="emp_city" placeholder="Employer's City" value="<?php if (isset($formData) && !empty($formData->emp_city)){echo $formData->emp_city;} ?>">
        </div>
        <div class="form-group col-lg-2">
            <input type="text" class="form-control" name="emp_province" placeholder="Employer's Province" value="<?php if (isset($formData) && !empty($formData->emp_province)){echo $formData->emp_province;} ?>">
        </div>
        <div class="form-group col-lg-2">
    ...
    <div class="row form-group">
        <div class="form-group col-lg-6">
            <input type="text" class="form-control" name="emp_occupation" placeholder="Employer's Occupation" value="<?php if (isset($formData) && !empty($formData->emp_occupation)){echo $formData->emp_occupation;} ?>">
        </div>
