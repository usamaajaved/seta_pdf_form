...
<div class="col-md-12">
    ...
    <div class="row text-center">
        <div class="col-md-12">
            <div class="custom-control custom-radio custom-control-inline mb-10">
            ...
            <div class="custom-control custom-radio custom-control-inline" style="margin-bottom: 10px !important;">
