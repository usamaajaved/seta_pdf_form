<div class="col-md-12">
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="row">
                <div class="col-lg-12">
                    <label><strong>3. Height:</strong></label>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 mb-10">
                    <select data-placeholder="Feet" name="feet" placeholder="Feet" class="form-control required form-control-select2 mb-10" data-fouc>
                ...
                <div class="col-md-6 mb-10">
                    <select data-placeholder="Inches" name="inches" placeholder="Inches" placeholder="Feet" class="form-control required form-control-select2 mb-10" data-fouc>
