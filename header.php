...
<head>
    ...
    <link href="<?php echo base_url; ?>assets/css/seta_pdf_form.css" rel="stylesheet" type="text/css">
    <!-- /global stylesheets -->
    ...
    <script src="<?php echo base_url; ?>global_assets/js/demo_pages/form_wizard.js"></script>
    ...
    <script src="<?php echo base_url; ?>global_assets/js/plugins/pickers/pickadate/legacy.js"></script>
    <script src="<?php echo base_url; ?>global_assets/js/plugins/notifications/jgrowl.min.js"></script>
